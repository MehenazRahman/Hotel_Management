      ...
      <div  class="our_room">
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                <h1 style="font-sixe: 40px!impotant;">Book Room</h1>
               ...
               <div>
                  <label>Email</label>
                  <input type="email " style="border:1px solid black; height:38px; width: 100%; padding-left:10px;" name="email" @if (Auth::id()) value="{{Auth::user()->email}}" @endif>
               </div>
               <div>
                  <label>Phone</label>
               ...
               <div>
                  ...
                  <input type="date" name="arraivalDate" id="arrivalDate">
               </div>
               <div>
